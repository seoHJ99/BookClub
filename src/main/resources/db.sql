...
-- 맴버 데이터
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (1, 'Aspirin', 'Green Pepper', 'KELY', 'Female', '337941086995106', 'cdamiata0@xrea.com', '1,2', '1');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (2, 'Bright', 'Homeopathic', 'NCPK', 'Male', '337941134576635', 'scoie1@woothemes.com', '', '1,2');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (3, 'Cheratussin', 'OXYBUTYNIN', 'EGHD', 'Male', '374622544743528', 'cgilroy2@163.com', '3,4', '3');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (4, 'citroma', 'Hydrocodone', 'LKZA', 'Female', '372301305734834', 'sgaynes3@icq.com', '', '1,2,3,4,5');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (5, 'Pacific', 'TUNA', 'RPVJ', 'Female', '374283846796027', 'jjosuweit4@prnewswire.com', '5,6,7', '5');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (6, 'Naproxen', 'Anas', 'ZUMY', 'Male', '337941102079067', 'adalinder5@cnet.com', '', '2,1');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (7, 'VIDAZA', 'AZITHROMYCIN', 'LGAV', 'Female', '341721422227131', 'jbleckly6@devhub.com', '11', '4');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (8, 'Greasewood', 'Triamterene', 'WSSS', 'Male', '374622813789087', 'ghouselee7@google.ca', '8,9', '3');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (9, 'Bamboo', 'rx act', 'UOII', 'Female', '374283726602691', 'aastley8@msu.edu', '10', '3');
insert into member (NO, ID, pw, nickname, location, introduce, mail, review_board, join_club) values (10, 'Preference', 'Lidocaine', 'HKGA', 'Female', '374283752709428', 'ddamp9@devhub.com', '', '');
